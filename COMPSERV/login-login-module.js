...
const routes = [
    {
        ...
        children: [
            {
                path: 'simple',
                loadChildren: () => Promise.all(/*! import() | basic-login-basic-login-module */[__webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~5e332ada"), __webpack_require__.e("basic-login-basic-login-module")]).then(__webpack_require__.bind(null, /*! ./basic-login/basic-login.module */ "./src/app/theme/auth/login/basic-login/basic-login.module.ts")).then(m => m.BasicLoginModule)
            },
            {
                path: 'header-footer',
