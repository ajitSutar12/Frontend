...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'data',
                loadChildren: () => Promise.all(/*! import() | data-widget-data-widget-module */[__webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~5e332ada"), __webpack_require__.e("default~analytics-analytics-module~chart-js-chart-js-module~chart-widget-chart-widget-module~crm-das~590074bb"), __webpack_require__.e("default~advance-elements-advance-elements-module~crm-dashboard-crm-dashboard-module~data-widget-data~3d7ac973"), __webpack_require__.e("default~crm-dashboard-crm-dashboard-module~data-widget-data-widget-module~default-default-module~goo~78a206b6"), __webpack_require__.e("data-widget-data-widget-module")]).then(__webpack_require__.bind(null, /*! ./data-widget/data-widget.module */ "./src/app/theme/widget/data-widget/data-widget.module.ts")).then(m => m.DataWidgetModule)
            },
            {
                path: 'chart',
                loadChildren: () => Promise.all(/*! import() | chart-widget-chart-widget-module */[__webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~5e332ada"), __webpack_require__.e("default~analytics-analytics-module~chart-js-chart-js-module~chart-widget-chart-widget-module~crm-das~590074bb"), __webpack_require__.e("default~analytics-analytics-module~chart-widget-chart-widget-module~crm-dashboard-crm-dashboard-modu~09265e44"), __webpack_require__.e("chart-widget-chart-widget-module")]).then(__webpack_require__.bind(null, /*! ./chart-widget/chart-widget.module */ "./src/app/theme/widget/chart-widget/chart-widget.module.ts")).then(m => m.ChartWidgetModule)
            },
            {
                path: 'advanced',
