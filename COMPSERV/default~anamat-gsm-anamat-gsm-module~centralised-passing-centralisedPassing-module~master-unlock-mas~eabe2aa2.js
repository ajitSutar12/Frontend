...
class AnamatGSMComponent {
    ...
    createForm() {
        this.angForm = this.fb.group({
            AC_OPDATE: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]({ value: '', disabled: true }),
            AC_ACNOTYPE: ['GS'],
