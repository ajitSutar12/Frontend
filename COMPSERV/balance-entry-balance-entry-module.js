        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | balance-updation-balance-updation-module */[__webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~28f99363"), __webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~5e332ada"), __webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~ff90df50"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~anamat-gsm-ana~b4ec420a"), __webpack_require__.e("balance-updation-balance-updation-module")]).then(__webpack_require__.bind(null, /*! ./balance-updation/balance-updation.module */ "./src/app/theme/master/balance-entry/balance-updation/balance-updation.module.ts")).then(m => m.BalanceUpdationModule)
            },
            {
                path: 'balanceOSCDA',
                loadChildren: () => __webpack_require__.e(/*! import() | balance-oscda-balance-oscda-module */ "balance-oscda-balance-oscda-module").then(__webpack_require__.bind(null, /*! ./balance-oscda/balance-oscda.module */ "./src/app/theme/master/balance-entry/balance-oscda/balance-oscda.module.ts")).then(m => m.BalanceOSCDAModule)
            },
            {
                path: 'balanceofpigmy',
                loadChildren: () => __webpack_require__.e(/*! import() | balanceofpigmy-balanceofpigmy-module */ "balanceofpigmy-balanceofpigmy-module").then(__webpack_require__.bind(null, /*! ./balanceofpigmy/balanceofpigmy.module */ "./src/app/theme/master/balance-entry/balanceofpigmy/balanceofpigmy.module.ts")).then(m => m.BalanceofpigmyModule)
            },
            {
                path: 'balanceOLCD',
                loadChildren: () => __webpack_require__.e(/*! import() | balance-olcd-balance-olcd-module */ "balance-olcd-balance-olcd-module").then(__webpack_require__.bind(null, /*! ./balance-olcd/balance-olcd.module */ "./src/app/theme/master/balance-entry/balance-olcd/balance-olcd.module.ts")).then(m => m.BalanceOLCDModule)
            },
            {
                path: 'memberWBA',
                loadChildren: () => __webpack_require__.e(/*! import() | member-wba-member-wba-module */ "member-wba-member-wba-module").then(__webpack_require__.bind(null, /*! ./member-wba/member-wba.module */ "./src/app/theme/master/balance-entry/member-wba/member-wba.module.ts")).then(m => m.MemberWBAModule)
            },
            {
                path: 'member',
                loadChildren: () => __webpack_require__.e(/*! import() | member-member-module */ "member-member-module").then(__webpack_require__.bind(null, /*! ./member/member.module */ "./src/app/theme/master/balance-entry/member/member.module.ts")).then(m => m.MemberModule)
            },
            {
                path: 'reconciliationOTE',
                loadChildren: () => __webpack_require__.e(/*! import() | reconciliation-ote-reconciliation-ote-module */ "reconciliation-ote-reconciliation-ote-module").then(__webpack_require__.bind(null, /*! ./reconciliation-ote/reconciliation-ote.module */ "./src/app/theme/master/balance-entry/reconciliation-ote/reconciliation-ote.module.ts")).then(m => m.ReconciliationOTEModule)
            },
            {
                path: 'reconciliationTE',
                loadChildren: () => __webpack_require__.e(/*! import() | reconciliation-transaction-entry-reconciliation-transaction-entry-module */ "reconciliation-transaction-entry-reconciliation-transaction-entry-module").then(__webpack_require__.bind(null, /*! ./reconciliation-transaction-entry/reconciliation-transaction-entry.module */ "./src/app/theme/master/balance-entry/reconciliation-transaction-entry/reconciliation-transaction-entry.module.ts")).then(m => m.ReconciliationTransactionEntryModule)
            },
            {
                path: 'loanieacdu',
                loadChildren: () => Promise.all(/*! import() | loan-installment-edit-and-close-date-updation-loan-installment-edit-and-close-date-updation-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~a0fa725c"), __webpack_require__.e("loan-installment-edit-and-close-date-updation-loan-installment-edit-and-close-date-updation-module")]).then(__webpack_require__.bind(null, /*! ./loan-installment-edit-and-close-date-updation/loan-installment-edit-and-close-date-updation.module */ "./src/app/theme/master/balance-entry/loan-installment-edit-and-close-date-updation/loan-installment-edit-and-close-date-updation.module.ts")).then(m => m.ReconciliationTransactionEntryModule)
            },
        ]
    }
];
...
BalanceEntryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BalanceEntryComponent, selectors: [["app-balance-entry"]], decls: 2, vars: 0, template: function BalanceEntryComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, styles: [".required[_ngcontent-%COMP%] {\n  color: red;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
