...
/***/ "./src/app/theme/process/holiday/holiday-routing.module.ts":
/*!*****************************************************************!*\
  !*** ./src/app/theme/process/holiday/holiday-routing.module.ts ***!
  \*****************************************************************/
...
/* harmony import */ var _holiday_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./holiday.component */ "./src/app/theme/process/holiday/holiday.component.ts");
...
/***/ "./src/app/theme/process/holiday/holiday.component.ts":
/*!************************************************************!*\
  !*** ./src/app/theme/process/holiday/holiday.component.ts ***!
  \************************************************************/
...
/* harmony import */ var _holiday_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./holiday.service */ "./src/app/theme/process/holiday/holiday.service.ts");
...
class HolidayComponent {
    ...
    ngOnInit() {
        this.getDataSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(1000).subscribe((x => {
            ...
            var sysDate;
            let ssysDate = moment__WEBPACK_IMPORTED_MODULE_2__(result.branch.syspara.CURRENT_DATE, 'DD-MM-YYYY');
            sysDate = (ssysDate['_d']);
...
HolidayComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HolidayComponent, selectors: [["app-holiday"]], decls: 18, vars: 1, consts: [[1, "row"], [1, "col-12"], [1, "card"], [1, "card-header"], [1, "requiredlable", 2, "float", "right", "font-size", "12px", "color", "black"], [1, "required"], [1, "card-block"], [1, "col-sm"], [1, "col-sm-8"], [3, "options"]], template: function HolidayComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_fullcalendar_angular__WEBPACK_IMPORTED_MODULE_7__["FullCalendarComponent"]], styles: [".required {\n  color: red;\n}\n\ntr:hover {\n  background-color: white !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"], encapsulation: 2 });
...
/***/ "./src/app/theme/process/holiday/holiday.module.ts":
/*!*********************************************************!*\
  !*** ./src/app/theme/process/holiday/holiday.module.ts ***!
  \*********************************************************/
...
/* harmony import */ var _holiday_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./holiday.component */ "./src/app/theme/process/holiday/holiday.component.ts");
/* harmony import */ var _holiday_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./holiday-routing.module */ "./src/app/theme/process/holiday/holiday-routing.module.ts");
...
/* harmony import */ var _holiday_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./holiday.service */ "./src/app/theme/process/holiday/holiday.service.ts");
...
/***/ "./src/app/theme/process/holiday/holiday.service.ts":
/*!**********************************************************!*\
  !*** ./src/app/theme/process/holiday/holiday.service.ts ***!
  \**********************************************************/
...
class HolidayService {
    ...
    //Deletion Operation
    deleteData(date) {
        return this.http.post(this.url + '/holiday/delete', date).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    }
}
