...
/* harmony import */ var _header_footer_reg_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./header-footer-reg.component */ "./src/app/theme/auth/registration/header-footer-reg/header-footer-reg.component.ts");
...
const routes = [
    {
        path: '',
        component: _header_footer_reg_component__WEBPACK_IMPORTED_MODULE_2__["HeaderFooterRegComponent"],
        data: {
            title: 'Header & Footer Reg'
        }
    }
];
class HeaderFooterRegRoutingModule {
}
HeaderFooterRegRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: HeaderFooterRegRoutingModule });
HeaderFooterRegRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function HeaderFooterRegRoutingModule_Factory(t) { return new (t || HeaderFooterRegRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](HeaderFooterRegRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HeaderFooterRegRoutingModule, [{
...
class HeaderFooterRegComponent {
    constructor() {
        this.navType = 'st2';
...
HeaderFooterRegComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderFooterRegComponent, selectors: [["app-header-footer-reg"]], decls: 169, vars: 23, consts: [["id", "pcoded", 1, "pcoded", 3, "resize"], [1, "pcoded-overlay-box"], [1, "pcoded-container", "navbar-wrapper"], [1, "navbar", "header-navbar", "pcoded-header"], [1, "navbar-wrapper"], [1, "navbar-logo"], [1, "ripple", "light", 3, "routerLink"], ["src", "assets/images/logo.png", "alt", "Mega Able"], ["href", "javascript:", 1, "mobile-options", "ripple", "light", 3, "click"], [1, "icon-more"], [1, "navbar-container"], [1, "nav-left"], [1, "ripple", "light"], [1, "sidebar_toggle"], ["href", "javascript:"], [1, "icon-menu"], [1, "header-search"], ["id", "main-search", 1, "main-search", "morphsearch-search"], [1, "input-group"], [1, "input-group-prepend", "search-close", 3, "click"], [1, "icon-close", "input-group-text"], [1, "form-control"], [1, "input-group-append", "search-btn", 3, "click"], [1, "icon-search", "input-group-text"], ["appToggleFullScreen", "", 1, "ripple", "light"], [1, "icon-fullscreen"], [1, "nav-right", 3, "ngClass"], [1, "header-notification", "ripple", "light", 3, "ngClass", "clickOutside", "click"], [1, "icon-bell"], [1, "badge", "bg-c-red"], [1, "show-notification"], [1, "label", "label-danger"], [1, "ripple"], [1, "media"], ["src", "assets/images/avatar-2.jpg", "alt", "Generic placeholder image", 1, "d-flex", "align-self-center", "img-radius"], [1, "media-body"], [1, "notification-user"], [1, "notification-msg"], [1, "notification-time"], ["src", "assets/images/avatar-4.jpg", "alt", "Generic placeholder image", 1, "d-flex", "align-self-center", "img-radius"], ["src", "assets/images/avatar-3.jpg", "alt", "Generic placeholder image", 1, "d-flex", "align-self-center", "img-radius"], [1, "user-profile", "header-notification", "ripple", "light", 3, "ngClass", "clickOutside", "click"], ["src", "assets/images/avatar-4.jpg", "alt", "User-Profile-Image", 1, "img-radius"], [1, "icon-angle-down"], [1, "show-notification", "profile-notification"], [1, "icon-settings"], [3, "routerLink"], [1, "icon-user"], [1, "icon-email"], ["target", "_blank", 3, "routerLink"], [1, "icon-lock"], [1, "icon-layout-sidebar-left"], [1, "login-block"], [1, "container-fluid"], [1, "row"], [1, "col-sm-12"], [1, "md-float-material", "form-material", "m-t-40", "m-b-40"], [1, "auth-box", "card"], [1, "card-block"], [1, "row", "m-b-20"], [1, "col-md-12"], [1, "text-center", "txt-primary"], [1, "form-group", "form-primary"], ["type", "text", "name", "user-name", "required", "", 1, "form-control"], [1, "form-bar"], [1, "float-label"], ["type", "text", "name", "email", "required", "", 1, "form-control"], [1, "col-sm-6"], ["type", "password", "name", "password", "required", "", 1, "form-control"], ["type", "password", "name", "confirm-password", "required", "", 1, "form-control"], [1, "row", "m-t-25", "text-left"], [1, "checkbox-fade", "fade-in-primary"], ["type", "checkbox", "value", ""], [1, "cr"], [1, "cr-icon", "fa", "fa-check", "txt-primary"], [1, "text-inverse"], [1, "row", "m-t-30"], ["type", "button", 1, "btn", "btn-primary", "btn-md", "btn-block", "waves-light", "text-center", "m-b-20", "ripple"], [1, "col-md-10"], [1, "text-inverse", "text-left", "m-b-0"], [1, "text-inverse", "text-left"], [1, "col-md-2"], ["src", "assets/images/auth/Logo-small-bottom.png", "alt", "small-logo.png"], [1, "footer"], [1, "text-center", "m-b-0"]], template: function HeaderFooterRegComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderFooterRegComponent_Template_a_click_8_listener() { return ctx.toggleHeaderNavRight(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderFooterRegComponent_Template_span_click_19_listener() { return ctx.searchOff(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderFooterRegComponent_Template_span_click_22_listener() { return ctx.searchOn(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("clickOutside", function HeaderFooterRegComponent_Template_li_clickOutside_28_listener() { return ctx.notificationOutsideClick("live"); })("click", function HeaderFooterRegComponent_Template_li_click_28_listener() { return ctx.toggleLiveNotification(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("clickOutside", function HeaderFooterRegComponent_Template_li_clickOutside_68_listener() { return ctx.notificationOutsideClick("profile"); })("click", function HeaderFooterRegComponent_Template_li_click_68_listener() { return ctx.toggleProfileNotification(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](110, "Choose Username");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](115, "Your Email Address");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](119, "input", 68);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](120, "span", 64);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](121, "label", 65);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](125, "input", 69);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](126, "span", 64);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](127, "label", 65);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](128, "Confirm Password");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](133, "input", 72);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](136, "span", 75);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](137, "I read and accept ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](138, "a", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](139, "Terms & Conditions.");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](145, "i", 74);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](146, "span", 75);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](147, "Send me the ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](148, "a", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](149, "Newsletter");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](153, "button", 77);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](154, "Sign up now");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](158, "p", 79);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](159, "Thank you.");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](160, "p", 80);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](163, "Back to website");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](167, "p", 84);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](168, "Copyright \u00A9 2017 MEGA ABLE ADMIN , All rights reserved.");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HeaderFooterRegComponent, [{
...
/* harmony import */ var _header_footer_reg_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./header-footer-reg.component */ "./src/app/theme/auth/registration/header-footer-reg/header-footer-reg.component.ts");
/* harmony import */ var _header_footer_reg_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./header-footer-reg-routing.module */ "./src/app/theme/auth/registration/header-footer-reg/header-footer-reg-routing.module.ts");
...
class HeaderFooterRegModule {
}
HeaderFooterRegModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: HeaderFooterRegModule });
HeaderFooterRegModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function HeaderFooterRegModule_Factory(t) { return new (t || HeaderFooterRegModule)(); }, imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            _header_footer_reg_routing_module__WEBPACK_IMPORTED_MODULE_3__["HeaderFooterRegRoutingModule"],
            _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](HeaderFooterRegModule, { declarations: [_header_footer_reg_component__WEBPACK_IMPORTED_MODULE_2__["HeaderFooterRegComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _header_footer_reg_routing_module__WEBPACK_IMPORTED_MODULE_3__["HeaderFooterRegRoutingModule"],
        _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HeaderFooterRegModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
                imports: [
                    _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                ...
                declarations: [_header_footer_reg_component__WEBPACK_IMPORTED_MODULE_2__["HeaderFooterRegComponent"]]
            }]
    }], null, null); })();
