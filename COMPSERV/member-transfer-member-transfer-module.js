        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | member-transfer-transaction-member-transfer-transaction-module */[__webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~accept-d-accept-d-module~0a0ac926"), __webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~28f99363"), __webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~ff90df50"), __webpack_require__.e("member-transfer-transaction-member-transfer-transaction-module")]).then(__webpack_require__.bind(null, /*! ./member-transfer-transaction/member-transfer-transaction.module */ "./src/app/theme/transaction/member-transfer/member-transfer-transaction/member-transfer-transaction.module.ts")).then(m => m.MemberTransferTransactionModule)
            },
            {
                path: 'BranchAndSalaryDC',
                loadChildren: () => Promise.all(/*! import() | branch-and-salary-dc-branch-and-salary-dc-module */[__webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~accept-d-accept-d-module~0a0ac926"), __webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~28f99363"), __webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~5e332ada"), __webpack_require__.e("default~abr-alr-abr-alr-module~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-~ff90df50"), __webpack_require__.e("branch-and-salary-dc-branch-and-salary-dc-module")]).then(__webpack_require__.bind(null, /*! ./branch-and-salary-dc/branch-and-salary-dc.module */ "./src/app/theme/transaction/member-transfer/branch-and-salary-dc/branch-and-salary-dc.module.ts")).then(m => m.BranchAndSalaryDCModule)
            },
            {
                path: 'TrasferredMemberOB',
                loadChildren: () => __webpack_require__.e(/*! import() | trasferred-member-ob-trasferred-member-ob-module */ "trasferred-member-ob-trasferred-member-ob-module").then(__webpack_require__.bind(null, /*! ./trasferred-member-ob/trasferred-member-ob.module */ "./src/app/theme/transaction/member-transfer/trasferred-member-ob/trasferred-member-ob.module.ts")).then(m => m.TrasferredMemberOBModule)
            },
        ]
    }
];
...
MemberTransferModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function MemberTransferModule_Factory(t) { return new (t || MemberTransferModule)(); }, providers: [{
