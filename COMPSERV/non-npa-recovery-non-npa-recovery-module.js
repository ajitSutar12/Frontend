...
function NonNpaRecoveryComponent_ng_option_46_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ng-option", 32);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
class NonNpaRecoveryComponent {
    ...
    view(event) {
        ...
        if (this.ngForm.valid) {
            ...
            this.iframe5url = this.report_url + "examples/ToBeRecoveryforNonNPAReport.php?AC_TYPE=" + schemeName + "&BRANCH_CODE=" + this.ngbranch + "&FLAG=" + flag + "&BranchName='" + this.branchName + "'&dt='" + npaDate + "'&schemeCode='" + scheme + "'&bankName='" + bankName + "'";
...
NonNpaRecoveryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NonNpaRecoveryComponent, selectors: [["app-non-npa-recovery"]], viewQuery: function NonNpaRecoveryComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 69, vars: 11, consts: [[1, "row"], [1, "col-12"], [1, "card"], [1, "card-header"], [1, "requiredlable", 2, "float", "right", "font-size", "12px", "color", "black"], [1, "required"], [3, "formGroup"], [1, "card-block"], [1, "col-sm-12", "col-md-1"], ["for", "Branch"], [1, "col-sm-12", "col-md-2"], [1, "form-group", "form-primary", "form-static-label"], [1, "border-lable-flt"], ["id", "BRANCH_CODE", "bindValue", "value", "binfdlable", "lable", "formControlName", "BRANCH_CODE", "bindLabel", "label", "placeholder", "Branch", 3, "ngModel", "ngModelChange", "change"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "form-group form-primary form-static-label", "class", "alert alert-danger", 4, "ngIf"], ["for", " Date"], [1, "col-sm-2", "col-md-3"], ["formControlName", "Scheme_code", "bindValue", "value", "bindLabel", "label", 3, "ngModel", "ngModelChange", "change"], [1, "col-sm-2", "col-md-2"], ["formControlName", "NPA_Date", 3, "ngModel", "ngModelChange"], [1, "col-sm"], [1, "checkbox", "checkbox-primary"], [1, "border-checkbox-group", "border-checkbox-group-primary"], ["type", "checkbox", "id", "npa_per", "formControlName", "npa_per", 1, "border-checkbox"], ["for", "npa_per", 1, "border-checkbox-label"], [1, "col-md-9"], [1, "col-md-2"], ["value", "submit", 1, "btn", "btn-outline-primary", "btn-sm", 3, "disabled", "click"], [1, "col-md-1"], [1, "btn", "btn-outline-primary", "btn-sm", 3, "click"], [4, "ngIf"], [3, "value"], [1, "alert", "alert-danger"], [3, "url", "load"]], template: function NonNpaRecoveryComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function NonNpaRecoveryComponent_Template_ng_select_ngModelChange_45_listener($event) { return ctx.nasf = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](46, NonNpaRecoveryComponent_ng_option_46_Template, 2, 2, "ng-option", 14);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NonNpaRecoveryComponent_Template_button_click_57_listener($event) { ctx.view($event); return ctx.scrollToTop(); });
