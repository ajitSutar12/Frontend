...
class ResetpasswordComponent {
    ...
    resetpassword() {
        if (this.currentPassword == '') {
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire('Oops!', 'Please insert you current password', 'error');
        }
        else if (this.newPassword != this.confirmPassword) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire('Oops!', 'Your password not matched', 'error');
        }
        else {
            let resetpassword = {
            ...
            this._authService.resetPassword(resetpassword).subscribe(data => {
                ...
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire('Oops!', error.error.message, 'error');
            });
        }
    }
}
...
ResetpasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ResetpasswordComponent, selectors: [["app-resetpassword"]], decls: 51, vars: 7, consts: [[1, "login-block"], [1, "container-fluid"], [1, "row"], [1, "col-sm-12"], ["action", "javascript:"], [1, "auth-box", "card"], [1, "card-block"], [1, "row", "m-b-20"], [1, "col-md-12"], [1, "text-left"], [1, "col-sm"], [1, "form-group", "input-group"], [1, "border-lable-flt"], ["type", "email", "name", "username", "placeholder", " ", "title", "Enter valid UserName", "id", "username", 1, "form-control", 3, "ngModel", "ngModelChange"], ["for", "username"], ["type", "email", "name", "currentPassword", "placeholder", " ", "title", "Enter valid Email", "id", "Current_Password", 1, "form-control", 3, "NgPasswordValidator", "ngModel", "valid", "keyup", "ngModelChange"], ["for", "Current_Password"], ["type", "password", "name", "Create_Password", "pattern", "^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,12}$", "minlength", "4", "placeholder", " ", "id", "Create_Password", "required", "", 1, "form-control", 3, "NgPasswordValidator", "ngModel", "valid", "keyup", "ngModelChange"], ["for", "Create_Password"], [1, "required"], ["type", "password", "name", "Confirm_Password", "pattern", "^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,12}$", "placeholder", " ", "id", "Confirm_Password", 1, "form-control", 3, "NgPasswordValidator", "ngModel", "focusout", "valid", "keyup", "ngModelChange"], ["for", "Confirm_Password"], ["type", "button", 1, "btn", "btn-primary", "btn-md", "btn-block", "waves-light", "text-center", "m-b-20", "ripple", 3, "click"], [1, "col-md-8"], [1, "col-md-4"], ["src", "assets/images/comp.png", "alt", "small-logo.png"]], template: function ResetpasswordComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ResetpasswordComponent_Template_input_ngModelChange_15_listener($event) { return ctx.username = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
