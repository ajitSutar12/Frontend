...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'select',
                loadChildren: () => Promise.all(/*! import() | form-select-form-select-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~fb622f9d"), __webpack_require__.e("default~day-book-ie-day-book-ie-module~demand-draft-dei-demand-draft-dei-module~demo-demo-module~for~21e8873b"), __webpack_require__.e("default~advance-elements-advance-elements-module~crm-dashboard-crm-dashboard-module~data-widget-data~3d7ac973"), __webpack_require__.e("default~advance-elements-advance-elements-module~form-select-form-select-module"), __webpack_require__.e("form-select-form-select-module")]).then(__webpack_require__.bind(null, /*! ./form-select/form-select.module */ "./src/app/theme/forms/form-select/form-select.module.ts")).then(m => m.FormSelectModule)
            },
            {
                path: 'form-wizards',
