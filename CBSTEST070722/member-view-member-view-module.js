...
MemberViewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MemberViewComponent, selectors: [["app-member-view"]], decls: 78, vars: 1, consts: [[1, "row"], [1, "col-12"], [1, "card"], [1, "card-header"], [2, "float", "right"], [1, "required"], ["action", "javascript:"], [1, "card-block"], [1, "col-sm"], [1, "form-group", "input-group"], [1, "border-lable-flt"], ["type", "text", "name", "MemberNo", "placeholder", " ", "id", "MemberNo", "required", "", 1, "form-control"], ["for", "MemberNo"], ["type", "text", "name", "EmployeeNo", "placeholder", " ", "id", "EmployeeNo", "required", "", 1, "form-control"], ["for", "EmployeeNo"], ["type", "text", "name", "Date", "placeholder", " ", "id", "Date", "onfocus", "(this.type='date')", "formControlName", "Date", 1, "form-control"], ["for", "Date"], ["type", "text", "name", "TotalLoanAmount", "placeholder", " ", "id", "TotalLoanAmount", "required", "", 1, "form-control"], ["for", "TotalLoanAmount"], ["type", "text", "name", "TotalDepositAmount", "placeholder", " ", "id", "TotalDepositAmount", "required", "", 1, "form-control"], ["for", "TotalDepositAmount"], ["type", "text", "name", "TotalInterestOnLoan", "placeholder", " ", "id", "TotalInterestOnLoan", "required", "", 1, "form-control"], ["for", "TotalInterestOnLoan"], ["type", "text", "name", "TotalInterestOnDeposit", "placeholder", " ", "id", "TotalInterestOnDeposit", "required", "", 1, "form-control"], ["for", "TotalInterestOnDeposit"], [1, "btn", "btn-primary", "ripple", "light"], [1, "col-lg-9"], [1, "table-responsive"], ["datatable", "", 1, "table", "table-striped", "table-bordered", "table-hover", 3, "dtOptions"]], template: function MemberViewComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](26, "Employee No.");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](40, "Total Loan Amount");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](49, "Total Deposit Amount");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](57, "Total Interest On Loan");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](65, "Total Interest On Deposit");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](77, "table", 28);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    } }, directives: [angular_datatables__WEBPACK_IMPORTED_MODULE_1__["DataTableDirective"]], styles: [".required[_ngcontent-%COMP%] {\n  color: red;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
