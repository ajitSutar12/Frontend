...
const routes = [
    {
        ...
        children: [
            {
                path: 'information',
                loadChildren: () => Promise.all(/*! import() | information-information-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~e0f20085"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~balance-updation-balance-updation-module~cash-credit-~92240c12"), __webpack_require__.e("default~definations-definations-module~information-information-module"), __webpack_require__.e("information-information-module")]).then(__webpack_require__.bind(null, /*! ./information/information.module */ "./src/app/theme/master/policy-settings/information/information.module.ts")).then(m => m.InformationModule)
            },
            {
                path: 'definations',
                loadChildren: () => Promise.all(/*! import() | definations-definations-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~e0f20085"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~anamat-gsm-ana~7e1b6053"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~analytics-anal~57f43bb7"), __webpack_require__.e("default~cash-credit-master-cash-credit-master-module~centralised-passing-centralisedPassing-module~d~b55a141a"), __webpack_require__.e("default~definations-definations-module~information-information-module"), __webpack_require__.e("common"), __webpack_require__.e("definations-definations-module")]).then(__webpack_require__.bind(null, /*! ./definations/definations.module */ "./src/app/theme/master/policy-settings/definations/definations.module.ts")).then(m => m.DefinationsModule)
            },
            {
                path: 'sizewiseBalanceModification',
                loadChildren: () => Promise.all(/*! import() | sizewise-balance-modification-sizewise-balance-modification-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~fb622f9d"), __webpack_require__.e("default~cash-credit-master-cash-credit-master-module~centralised-passing-centralisedPassing-module~d~b55a141a"), __webpack_require__.e("sizewise-balance-modification-sizewise-balance-modification-module")]).then(__webpack_require__.bind(null, /*! ./sizewise-balance-modification/sizewise-balance-modification.module */ "./src/app/theme/master/policy-settings/sizewise-balance-modification/sizewise-balance-modification.module.ts")).then(m => m.SizewiseBalanceModificationModule)
            },
            {
                path: 'tDReceiptTypeMaster',
                loadChildren: () => Promise.all(/*! import() | t-dreceipt-type-master-t-dreceipt-type-master-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~e0f20085"), __webpack_require__.e("t-dreceipt-type-master-t-dreceipt-type-master-module")]).then(__webpack_require__.bind(null, /*! ./t-dreceipt-type-master/t-dreceipt-type-master.module */ "./src/app/theme/master/policy-settings/t-dreceipt-type-master/t-dreceipt-type-master.module.ts")).then(m => m.TDReceiptTypeMasterModule)
            },
            {
                path: 'nPAClassificationSlabMaster',
                loadChildren: () => Promise.all(/*! import() | n-paclassification-slab-master-n-paclassification-slab-master-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~e0f20085"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~anamat-gsm-ana~7e1b6053"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~analytics-anal~57f43bb7"), __webpack_require__.e("n-paclassification-slab-master-n-paclassification-slab-master-module")]).then(__webpack_require__.bind(null, /*! ./n-paclassification-slab-master/n-paclassification-slab-master.module */ "./src/app/theme/master/policy-settings/n-paclassification-slab-master/n-paclassification-slab-master.module.ts")).then(m => m.NPAClassificationSlabMasterModule)
            },
        ]
    }
];
