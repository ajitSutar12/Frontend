        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | member-transfer-transaction-member-transfer-transaction-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~d038ec0a"), __webpack_require__.e("member-transfer-transaction-member-transfer-transaction-module")]).then(__webpack_require__.bind(null, /*! ./member-transfer-transaction/member-transfer-transaction.module */ "./src/app/theme/transaction/member-transfer/member-transfer-transaction/member-transfer-transaction.module.ts")).then(m => m.MemberTransferTransactionModule)
            },
            {
                path: 'BranchAndSalaryDC',
                loadChildren: () => Promise.all(/*! import() | branch-and-salary-dc-branch-and-salary-dc-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~d038ec0a"), __webpack_require__.e("branch-and-salary-dc-branch-and-salary-dc-module")]).then(__webpack_require__.bind(null, /*! ./branch-and-salary-dc/branch-and-salary-dc.module */ "./src/app/theme/transaction/member-transfer/branch-and-salary-dc/branch-and-salary-dc.module.ts")).then(m => m.BranchAndSalaryDCModule)
            },
            {
                path: 'TrasferredMemberOB',
                loadChildren: () => Promise.all(/*! import() | trasferred-member-ob-trasferred-member-ob-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~d038ec0a"), __webpack_require__.e("trasferred-member-ob-trasferred-member-ob-module")]).then(__webpack_require__.bind(null, /*! ./trasferred-member-ob/trasferred-member-ob.module */ "./src/app/theme/transaction/member-transfer/trasferred-member-ob/trasferred-member-ob.module.ts")).then(m => m.TrasferredMemberOBModule)
            },
        ]
    }
];
