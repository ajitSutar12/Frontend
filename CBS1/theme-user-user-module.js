(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["theme-user-user-module"],{

/***/ "./src/app/theme/user/user-routing.module.ts":
/*!***************************************************!*\
  !*** ./src/app/theme/user/user-routing.module.ts ***!
  \***************************************************/
...
const routes = [
    {
        ...
        children: [
            {
                path: 'profile',
                loadChildren: () => Promise.all(/*! import() | user-profile-user-profile-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~d038ec0a"), __webpack_require__.e("default~email-compose-email-compose-module~ext-tinymce-ext-tinymce-module~user-profile-user-profile-module"), __webpack_require__.e("user-profile-user-profile-module")]).then(__webpack_require__.bind(null, /*! ./user-profile/user-profile.module */ "./src/app/theme/user/user-profile/user-profile.module.ts")).then(m => m.UserProfileModule)
            },
            {
                path: 'card',
                loadChildren: () => __webpack_require__.e(/*! import() | user-card-user-card-module */ "user-card-user-card-module").then(__webpack_require__.bind(null, /*! ./user-card/user-card.module */ "./src/app/theme/user/user-card/user-card.module.ts")).then(m => m.UserCardModule)
            }
        ]
    }
];
...
/***/ "./src/app/theme/user/user.module.ts":
/*!*******************************************!*\
  !*** ./src/app/theme/user/user.module.ts ***!
  \*******************************************/
...
/* harmony import */ var _user_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user-routing.module */ "./src/app/theme/user/user-routing.module.ts");
...
//# sourceMappingURL=theme-user-user-module.js.map