...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'hotKeys',
                loadChildren: () => Promise.all(/*! import() | theme-hot-keys-hot-keys-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~d038ec0a"), __webpack_require__.e("theme-hot-keys-hot-keys-module")]).then(__webpack_require__.bind(null, /*! ./theme/hot-keys/hot-keys.module */ "./src/app/theme/hot-keys/hot-keys.module.ts")).then(m => m.HotkeysModule)
            },
            {
                path: 'exit',
            ...
            {
                path: 'data-table',
                loadChildren: () => Promise.all(/*! import() | theme-table-tbl-datatable-tbl-datatable-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~d038ec0a"), __webpack_require__.e("theme-table-tbl-datatable-tbl-datatable-module")]).then(__webpack_require__.bind(null, /*! ./theme/table/tbl-datatable/tbl-datatable.module */ "./src/app/theme/table/tbl-datatable/tbl-datatable.module.ts")).then(m => m.TblDatatableModule)
            },
            {
                path: 'user',
            ...
            {
                path: 'crm-contact',
                loadChildren: () => Promise.all(/*! import() | theme-crm-contact-crm-contact-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~d038ec0a"), __webpack_require__.e("theme-crm-contact-crm-contact-module")]).then(__webpack_require__.bind(null, /*! ./theme/crm-contact/crm-contact.module */ "./src/app/theme/crm-contact/crm-contact.module.ts")).then(m => m.CrmContactModule)
            },
            {
                path: 'task',
...
const environment = {
    ...
    // base_url: 'http://192.168.1.154:4000'
};
/*
