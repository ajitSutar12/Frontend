...
const routes = [
    {
        ...
        children: [
            {
                path: 'passbookIssue',
                loadChildren: () => Promise.all(/*! import() | passbook-issue-passbook-issue-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~d038ec0a"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~b9804476"), __webpack_require__.e("passbook-issue-passbook-issue-module")]).then(__webpack_require__.bind(null, /*! ./passbook-issue/passbook-issue.module */ "./src/app/theme/transaction/passbook-printing/passbook-issue/passbook-issue.module.ts")).then(m => m.PassbookIssueModule)
            },
            {
                path: 'passbookEntryPrint',
                loadChildren: () => Promise.all(/*! import() | passbook-entry-print-passbook-entry-print-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~d038ec0a"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~b9804476"), __webpack_require__.e("passbook-entry-print-passbook-entry-print-module")]).then(__webpack_require__.bind(null, /*! ./passbook-entry-print/passbook-entry-print.module */ "./src/app/theme/transaction/passbook-printing/passbook-entry-print/passbook-entry-print.module.ts")).then(m => m.PassbookEntryPrintModule)
            },
        ]
    }
];
