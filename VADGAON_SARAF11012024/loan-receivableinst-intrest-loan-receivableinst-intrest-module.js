...
LoanReceivableinstIntrestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoanReceivableinstIntrestComponent, selectors: [["app-loan-receivableinst-intrest"]], viewQuery: function LoanReceivableinstIntrestComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoanReceivableinstIntrestComponent_Template_button_click_58_listener($event) { ctx.view($event); return ctx.clicked = true; });
