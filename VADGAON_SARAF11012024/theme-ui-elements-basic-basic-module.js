...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'button',
                loadChildren: () => __webpack_require__.e(/*! import() | button-button-module */ "default~button-button-module~centralised-passing-centralisedPassing-module~master-unlock-masterUnloc~175cd2f5").then(__webpack_require__.bind(null, /*! ./button/button.module */ "./src/app/theme/ui-elements/basic/button/button.module.ts")).then(m => m.ButtonModule)
            },
            {
                path: 'box-shadow',
