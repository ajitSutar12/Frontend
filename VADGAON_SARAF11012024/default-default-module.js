...
const routes = [
    {
        ...
        children: [
            {
                path: 'demo',
                loadChildren: () => Promise.all(/*! import() | demo-demo-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~a0fa725c"), __webpack_require__.e("default~cash-credit-master-cash-credit-master-module~centralised-passing-centralisedPassing-module~d~6dad4c2a"), __webpack_require__.e("default~day-book-ie-day-book-ie-module~demand-draft-dei-demand-draft-dei-module~demo-demo-module~for~51e11cb8"), __webpack_require__.e("demo-demo-module")]).then(__webpack_require__.bind(null, /*! ./demo/demo.module */ "./src/app/theme/dashboard/default/demo/demo.module.ts")).then(m => m.DemoModule)
            },
            {
                path: 'demo1',
