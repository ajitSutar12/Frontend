...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'picker',
                loadChildren: () => Promise.all(/*! import() | form-picker-form-picker-module */[__webpack_require__.e("default~cash-credit-master-cash-credit-master-module~centralised-passing-centralisedPassing-module~d~6dad4c2a"), __webpack_require__.e("form-picker-form-picker-module")]).then(__webpack_require__.bind(null, /*! ./form-picker/form-picker.module */ "./src/app/theme/forms/form-picker/form-picker.module.ts")).then(m => m.FormPickerModule)
            },
            {
                path: 'mask',
