...
const routes = [
    {
        ...
        children: [
            {
                path: 'simple',
                loadChildren: () => Promise.all(/*! import() | basic-login-basic-login-module */[__webpack_require__.e("default~analytics-analytics-module~anamat-gsm-anamat-gsm-module~balance-updation-balance-updation-mo~4cee4e79"), __webpack_require__.e("basic-login-basic-login-module")]).then(__webpack_require__.bind(null, /*! ./basic-login/basic-login.module */ "./src/app/theme/auth/login/basic-login/basic-login.module.ts")).then(m => m.BasicLoginModule)
            },
            {
                path: 'header-footer',
