...
const routes = [
    {
        ...
        children: [
            {
                path: 'dividendList',
                loadChildren: () => Promise.all(/*! import() | dividend-list-dividend-list-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("dividend-list-dividend-list-module")]).then(__webpack_require__.bind(null, /*! ./dividend-list/dividend-list.module */ "./src/app/theme/utility/dividend/dividend-list/dividend-list.module.ts")).then(m => m.DividendListModule)
            },
            {
                path: 'dividendPost',
                loadChildren: () => Promise.all(/*! import() | dividend-post-dividend-post-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("dividend-post-dividend-post-module")]).then(__webpack_require__.bind(null, /*! ./dividend-post/dividend-post.module */ "./src/app/theme/utility/dividend/dividend-post/dividend-post.module.ts")).then(m => m.DividendPostModule)
            },
        ]
    }
];
