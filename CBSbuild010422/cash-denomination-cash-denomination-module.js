...
const routes = [
    {
        ...
        children: [
            {
                path: 'acceptD',
                loadChildren: () => Promise.all(/*! import() | accept-d-accept-d-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("accept-d-accept-d-module")]).then(__webpack_require__.bind(null, /*! ./accept-d/accept-d.module */ "./src/app/theme/transaction/cash-denomination/accept-d/accept-d.module.ts")).then(m => m.AcceptDModule)
            },
            {
                path: 'paymentDenomination',
                loadChildren: () => Promise.all(/*! import() | payment-denomination-payment-denomination-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("payment-denomination-payment-denomination-module")]).then(__webpack_require__.bind(null, /*! ./payment-denomination/payment-denomination.module */ "./src/app/theme/transaction/cash-denomination/payment-denomination/payment-denomination.module.ts")).then(m => m.PaymentDenominationModule)
            },
            {
                path: 'cashInDenomination',
                loadChildren: () => Promise.all(/*! import() | cash-in-denomination-cash-in-denomination-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("cash-in-denomination-cash-in-denomination-module")]).then(__webpack_require__.bind(null, /*! ./cash-in-denomination/cash-in-denomination.module */ "./src/app/theme/transaction/cash-denomination/cash-in-denomination/cash-in-denomination.module.ts")).then(m => m.CashInDenominationModule)
            },
            {
                path: 'cashOutDenomination',
                loadChildren: () => Promise.all(/*! import() | cash-out-denomination-cash-out-denomination-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("cash-out-denomination-cash-out-denomination-module")]).then(__webpack_require__.bind(null, /*! ./cash-out-denomination/cash-out-denomination.module */ "./src/app/theme/transaction/cash-denomination/cash-out-denomination/cash-out-denomination.module.ts")).then(m => m.CashOutDenominationModule)
            },
            {
                path: 'cashInitialisationEntry',
                loadChildren: () => Promise.all(/*! import() | cash-initialisation-entry-cash-initialisation-entry-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("cash-initialisation-entry-cash-initialisation-entry-module")]).then(__webpack_require__.bind(null, /*! ./cash-initialisation-entry/cash-initialisation-entry.module */ "./src/app/theme/transaction/cash-denomination/cash-initialisation-entry/cash-initialisation-entry.module.ts")).then(m => m.CashInitialisationEntryModule)
            },
            {
                path: 'safeValultToCashier',
                loadChildren: () => Promise.all(/*! import() | safe-vault-to-cashier-safe-vault-to-cashier-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("safe-vault-to-cashier-safe-vault-to-cashier-module")]).then(__webpack_require__.bind(null, /*! ./safe-vault-to-cashier/safe-vault-to-cashier.module */ "./src/app/theme/transaction/cash-denomination/safe-vault-to-cashier/safe-vault-to-cashier.module.ts")).then(m => m.SafeValultToCashierModule)
            },
            {
                path: 'cashierToSafeVault',
                loadChildren: () => Promise.all(/*! import() | cashier-to-safe-vault-cashier-to-safe-vault-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("cashier-to-safe-vault-cashier-to-safe-vault-module")]).then(__webpack_require__.bind(null, /*! ./cashier-to-safe-vault/cashier-to-safe-vault.module */ "./src/app/theme/transaction/cash-denomination/cashier-to-safe-vault/cashier-to-safe-vault.module.ts")).then(m => m.CashierToSafeVaultModule)
            },
        ]
    }
];
