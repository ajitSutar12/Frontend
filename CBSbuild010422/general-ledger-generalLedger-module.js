        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | gl-statement-code-gl-statement-code-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("gl-statement-code-gl-statement-code-module")]).then(__webpack_require__.bind(null, /*! ./gl-statement-code/gl-statement-code.module */ "./src/app/theme/master/general-ledger/gl-statement-code/gl-statement-code.module.ts")).then(m => m.GlStatementCodeModule)
            },
            {
                path: 'gl-accounts-master',
                loadChildren: () => Promise.all(/*! import() | gl-accounts-master-gl-account-master-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("common"), __webpack_require__.e("gl-accounts-master-gl-account-master-module")]).then(__webpack_require__.bind(null, /*! ./gl-accounts-master/gl-account-master.module */ "./src/app/theme/master/general-ledger/gl-accounts-master/gl-account-master.module.ts")).then(m => m.GlAccountsMasterModule)
            },
            {
                path: 'gl-report-master',
                loadChildren: () => Promise.all(/*! import() | gl-report-master-gl-report-master-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("gl-report-master-gl-report-master-module")]).then(__webpack_require__.bind(null, /*! ./gl-report-master/gl-report-master.module */ "./src/app/theme/master/general-ledger/gl-report-master/gl-report-master.module.ts")).then(m => m.GlReportMasterModule)
            },
            {
                path: 'gl-report-linking',
                loadChildren: () => Promise.all(/*! import() | gl-report-linking-gl-report-linking-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("gl-report-linking-gl-report-linking-module")]).then(__webpack_require__.bind(null, /*! ./gl-report-linking/gl-report-linking.module */ "./src/app/theme/master/general-ledger/gl-report-linking/gl-report-linking.module.ts")).then(m => m.GlReportLinkingModule)
            },
            {
                path: 'budget-master',
                loadChildren: () => Promise.all(/*! import() | budget-master-budgest-master-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("budget-master-budgest-master-module")]).then(__webpack_require__.bind(null, /*! ./budget-master/budgest-master.module */ "./src/app/theme/master/general-ledger/budget-master/budgest-master.module.ts")).then(m => m.BudgetMasterModule)
            },
        ]
    }
];
