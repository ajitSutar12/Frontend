...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'summary',
                loadChildren: () => Promise.all(/*! import() | invoice-summary-invoice-summary-module */[__webpack_require__.e("default~analytics-analytics-module~anamat-gsm-anamat-gsm-module~balance-updation-balance-updation-mo~4cee4e79"), __webpack_require__.e("default~analytics-analytics-module~chart-js-chart-js-module~chart-widget-chart-widget-module~crm-das~590074bb"), __webpack_require__.e("invoice-summary-invoice-summary-module")]).then(__webpack_require__.bind(null, /*! ./invoice-summary/invoice-summary.module */ "./src/app/theme/extension/invoice/invoice-summary/invoice-summary.module.ts")).then(m => m.InvoiceSummaryModule)
            },
            {
                path: 'list',
