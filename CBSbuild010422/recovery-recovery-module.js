        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | recovery-processing-recovery-processing-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("recovery-processing-recovery-processing-module")]).then(__webpack_require__.bind(null, /*! ./recovery-processing/recovery-processing.module */ "./src/app/theme/transaction/recovery/recovery-processing/recovery-processing.module.ts")).then(m => m.RecoveryProcessingModule)
            },
            {
                path: 'recoveryModification',
                loadChildren: () => Promise.all(/*! import() | recovery-modification-recovery-modification-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("recovery-modification-recovery-modification-module")]).then(__webpack_require__.bind(null, /*! ./recovery-modification/recovery-modification.module */ "./src/app/theme/transaction/recovery/recovery-modification/recovery-modification.module.ts")).then(m => m.RecoveryModificationModule)
            },
            {
                path: 'recoveryPosting',
                loadChildren: () => Promise.all(/*! import() | recovery-posting-recovery-posting-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("recovery-posting-recovery-posting-module")]).then(__webpack_require__.bind(null, /*! ./recovery-posting/recovery-posting.module */ "./src/app/theme/transaction/recovery/recovery-posting/recovery-posting.module.ts")).then(m => m.RecoveryPostingModule)
            },
            {
                path: 'recoveryDataImportExport',
                loadChildren: () => Promise.all(/*! import() | recovery-data-import-export-recovery-data-import-export-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3d3c692c"), __webpack_require__.e("default~all-reports-with-searching-allReportsWithSearching-module~anamat-gsm-anamat-gsm-module~cash-~357b9811"), __webpack_require__.e("recovery-data-import-export-recovery-data-import-export-module")]).then(__webpack_require__.bind(null, /*! ./recovery-data-import-export/recovery-data-import-export.module */ "./src/app/theme/transaction/recovery/recovery-data-import-export/recovery-data-import-export.module.ts")).then(m => m.RecoveryDataImportExportModule)
            },
        ]
    }
];
