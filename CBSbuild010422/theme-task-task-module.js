...
const routes = [
    {
        ...
        children: [
            {
                path: 'list',
                loadChildren: () => Promise.all(/*! import() | task-list-task-list-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("task-list-task-list-module")]).then(__webpack_require__.bind(null, /*! ./task-list/task-list.module */ "./src/app/theme/task/task-list/task-list.module.ts")).then(m => m.TaskListModule)
            },
            {
                path: 'board',
            ...
            {
                path: 'issue',
                loadChildren: () => Promise.all(/*! import() | task-issue-task-issue-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("task-issue-task-issue-module")]).then(__webpack_require__.bind(null, /*! ./task-issue/task-issue.module */ "./src/app/theme/task/task-issue/task-issue.module.ts")).then(m => m.TaskIssueModule)
            }
        ]
    }
];
...
TaskModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function TaskModule_Factory(t) { return new (t || TaskModule)(); }, providers: [{
