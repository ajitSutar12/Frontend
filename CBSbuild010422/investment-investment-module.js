        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | transaction-entry-transaction-entry-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3d3c692c"), __webpack_require__.e("transaction-entry-transaction-entry-module")]).then(__webpack_require__.bind(null, /*! ./transaction-entry/transaction-entry.module */ "./src/app/theme/master/investment/transaction-entry/transaction-entry.module.ts")).then(m => m.TransactionEntryModule)
            },
            {
                path: 'accountClosing',
                loadChildren: () => Promise.all(/*! import() | account-closing-account-closing-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3d3c692c"), __webpack_require__.e("account-closing-account-closing-module")]).then(__webpack_require__.bind(null, /*! ./account-closing/account-closing.module */ "./src/app/theme/master/investment/account-closing/account-closing.module.ts")).then(m => m.AccountClosingModule)
            },
            {
                path: 'accountOpenPassing',
                loadChildren: () => Promise.all(/*! import() | account-open-passing-account-open-passing-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3d3c692c"), __webpack_require__.e("account-open-passing-account-open-passing-module")]).then(__webpack_require__.bind(null, /*! ./account-open-passing/account-open-passing.module */ "./src/app/theme/master/investment/account-open-passing/account-open-passing.module.ts")).then(m => m.AccountOpenPassingModule)
            },
            {
                path: 'transactionPassing',
                loadChildren: () => Promise.all(/*! import() | transaction-passing-transaction-passing-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3d3c692c"), __webpack_require__.e("transaction-passing-transaction-passing-module")]).then(__webpack_require__.bind(null, /*! ./transaction-passing/transaction-passing.module */ "./src/app/theme/master/investment/transaction-passing/transaction-passing.module.ts")).then(m => m.TransactionPassingModule)
            },
            {
                path: 'accountClosePassing',
                loadChildren: () => Promise.all(/*! import() | account-close-passing-account-close-passing-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~134db10c"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3d3c692c"), __webpack_require__.e("account-close-passing-account-close-passing-module")]).then(__webpack_require__.bind(null, /*! ./account-close-passing/account-close-passing.module */ "./src/app/theme/master/investment/account-close-passing/account-close-passing.module.ts")).then(m => m.AccountClosePassingModule)
            },
        ]
    }
];
