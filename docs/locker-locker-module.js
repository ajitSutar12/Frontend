        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | locker-open-transaction-locker-open-transaction-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~cdbe0cfb"), __webpack_require__.e("locker-open-transaction-locker-open-transaction-module")]).then(__webpack_require__.bind(null, /*! ./locker-open-transaction/locker-open-transaction.module */ "./src/app/theme/transaction/locker/locker-open-transaction/locker-open-transaction.module.ts")).then(m => m.LockerOpenTransactionModule)
            },
            {
                path: 'lockerDepositAccountMaster',
                loadChildren: () => Promise.all(/*! import() | locker-deposit-account-master-locker-deposit-account-master-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~cdbe0cfb"), __webpack_require__.e("locker-deposit-account-master-locker-deposit-account-master-module")]).then(__webpack_require__.bind(null, /*! ./locker-deposit-account-master/locker-deposit-account-master.module */ "./src/app/theme/transaction/locker/locker-deposit-account-master/locker-deposit-account-master.module.ts")).then(m => m.LockerDepositAccountMasterModule)
            },
            {
                path: 'lockerRentTransaction',
                loadChildren: () => Promise.all(/*! import() | locker-rent-transactions-locker-rent-transactions-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~cdbe0cfb"), __webpack_require__.e("locker-rent-transactions-locker-rent-transactions-module")]).then(__webpack_require__.bind(null, /*! ./locker-rent-transactions/locker-rent-transactions.module */ "./src/app/theme/transaction/locker/locker-rent-transactions/locker-rent-transactions.module.ts")).then(m => m.LockerRentTransactionModule)
            },
        ]
    }
];
