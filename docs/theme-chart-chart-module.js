...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'chart-js',
                loadChildren: () => Promise.all(/*! import() | chart-js-chart-js-module */[__webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~analytics-anal~c26cab60"), __webpack_require__.e("default~analytics-analytics-module~chart-js-chart-js-module~chart-widget-chart-widget-module~crm-das~590074bb"), __webpack_require__.e("chart-js-chart-js-module")]).then(__webpack_require__.bind(null, /*! ./chart-js/chart-js.module */ "./src/app/theme/chart/chart-js/chart-js.module.ts")).then(m => m.ChartJsModule)
            },
            {
                path: 'radial',
