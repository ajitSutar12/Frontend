        ...
        children: [
            {
                ...
                loadChildren: () => __webpack_require__.e(/*! import() | member-transfer-transaction-member-transfer-transaction-module */ "member-transfer-transaction-member-transfer-transaction-module").then(__webpack_require__.bind(null, /*! ./member-transfer-transaction/member-transfer-transaction.module */ "./src/app/theme/transaction/member-transfer/member-transfer-transaction/member-transfer-transaction.module.ts")).then(m => m.MemberTransferTransactionModule)
            },
            {
                path: 'BranchAndSalaryDC',
                loadChildren: () => __webpack_require__.e(/*! import() | branch-and-salary-dc-branch-and-salary-dc-module */ "branch-and-salary-dc-branch-and-salary-dc-module").then(__webpack_require__.bind(null, /*! ./branch-and-salary-dc/branch-and-salary-dc.module */ "./src/app/theme/transaction/member-transfer/branch-and-salary-dc/branch-and-salary-dc.module.ts")).then(m => m.BranchAndSalaryDCModule)
            },
            {
