...
const routes = [
    {
        ...
        children: [
            {
                path: 'acceptD',
                loadChildren: () => Promise.all(/*! import() | accept-d-accept-d-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~cdbe0cfb"), __webpack_require__.e("accept-d-accept-d-module")]).then(__webpack_require__.bind(null, /*! ./accept-d/accept-d.module */ "./src/app/theme/transaction/cash-denomination/accept-d/accept-d.module.ts")).then(m => m.AcceptDModule)
            },
            {
            ...
            },
            {
                ...
                loadChildren: () => Promise.all(/*! import() | cash-in-denomination-cash-in-denomination-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~cdbe0cfb"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~all-reports-wi~65a2045d"), __webpack_require__.e("cash-in-denomination-cash-in-denomination-module")]).then(__webpack_require__.bind(null, /*! ./cash-in-denomination/cash-in-denomination.module */ "./src/app/theme/transaction/cash-denomination/cash-in-denomination/cash-in-denomination.module.ts")).then(m => m.CashInDenominationModule)
            },
            {
                path: 'cashOutDenomination',
                loadChildren: () => Promise.all(/*! import() | cash-out-denomination-cash-out-denomination-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-enquiry-account-enquiry-module~account-opening-account-open~cdbe0cfb"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~all-reports-wi~65a2045d"), __webpack_require__.e("cash-out-denomination-cash-out-denomination-module")]).then(__webpack_require__.bind(null, /*! ./cash-out-denomination/cash-out-denomination.module */ "./src/app/theme/transaction/cash-denomination/cash-out-denomination/cash-out-denomination.module.ts")).then(m => m.CashOutDenominationModule)
            },
            {
                path: 'cashInitialisationEntry',
                loadChildren: () => __webpack_require__.e(/*! import() | cash-initialisation-entry-cash-initialisation-entry-module */ "cash-initialisation-entry-cash-initialisation-entry-module").then(__webpack_require__.bind(null, /*! ./cash-initialisation-entry/cash-initialisation-entry.module */ "./src/app/theme/transaction/cash-denomination/cash-initialisation-entry/cash-initialisation-entry.module.ts")).then(m => m.CashInitialisationEntryModule)
            },
            {
                path: 'safeValultToCashier',
                loadChildren: () => __webpack_require__.e(/*! import() | safe-vault-to-cashier-safe-vault-to-cashier-module */ "safe-vault-to-cashier-safe-vault-to-cashier-module").then(__webpack_require__.bind(null, /*! ./safe-vault-to-cashier/safe-vault-to-cashier.module */ "./src/app/theme/transaction/cash-denomination/safe-vault-to-cashier/safe-vault-to-cashier.module.ts")).then(m => m.SafeValultToCashierModule)
            },
            {
                path: 'cashierToSafeVault',
                loadChildren: () => __webpack_require__.e(/*! import() | cashier-to-safe-vault-cashier-to-safe-vault-module */ "cashier-to-safe-vault-cashier-to-safe-vault-module").then(__webpack_require__.bind(null, /*! ./cashier-to-safe-vault/cashier-to-safe-vault.module */ "./src/app/theme/transaction/cash-denomination/cashier-to-safe-vault/cashier-to-safe-vault.module.ts")).then(m => m.CashierToSafeVaultModule)
            },
        ]
    }
];
