...
class DividendCalculationComponent {
    ...
    getAccountList() {
        ...
        if (this.formFromDate != this.divfromdate) {
            trandate = moment__WEBPACK_IMPORTED_MODULE_4__(this.angForm.controls["DIV_FROMDATE"].value).format('DD/MM/YYYY');
        }
        else {
...
DividendCalculationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DividendCalculationComponent, selectors: [["app-dividend-calculation"]], viewQuery: function DividendCalculationComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function DividendCalculationComponent_Template_input_ngModelChange_57_listener($event) { return ctx.divfromdate = $event; })("keypress", function DividendCalculationComponent_Template_input_keypress_57_listener($event) { return $event.charCode >= 48 && $event.charCode < 58 || $event.charCode == 47; })("bsValueChange", function DividendCalculationComponent_Template_input_bsValueChange_57_listener() { return ctx.checkDivYear(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
