        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | balance-updation-balance-updation-module */[__webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~all-reports-wi~65a2045d"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~account-opening-account-opening-module~analytics-anal~c26cab60"), __webpack_require__.e("default~account-enquiry-account-enquiry-module~all-reports-with-searching-allReportsWithSearching-mo~7b9e4e99"), __webpack_require__.e("balance-updation-balance-updation-module")]).then(__webpack_require__.bind(null, /*! ./balance-updation/balance-updation.module */ "./src/app/theme/master/balance-entry/balance-updation/balance-updation.module.ts")).then(m => m.BalanceUpdationModule)
            },
            {
                path: 'balanceOSCDA',
            ...
            {
                path: 'loanieacdu',
                loadChildren: () => Promise.all(/*! import() | loan-installment-edit-and-close-date-updation-loan-installment-edit-and-close-date-updation-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~8ccd25db"), __webpack_require__.e("loan-installment-edit-and-close-date-updation-loan-installment-edit-and-close-date-updation-module")]).then(__webpack_require__.bind(null, /*! ./loan-installment-edit-and-close-date-updation/loan-installment-edit-and-close-date-updation.module */ "./src/app/theme/master/balance-entry/loan-installment-edit-and-close-date-updation/loan-installment-edit-and-close-date-updation.module.ts")).then(m => m.ReconciliationTransactionEntryModule)
            },
        ]
    }
];
...
BalanceEntryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BalanceEntryComponent, selectors: [["app-balance-entry"]], decls: 2, vars: 0, template: function BalanceEntryComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, styles: [".required[_ngcontent-%COMP%] {\n  color: red;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
