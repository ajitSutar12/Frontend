...
export const environment = {
  ...
  // base_url: 'http://139.59.63.215:4771',  //CBS test sidhanerli server
  ...
  // report_url: 'http://139.59.63.215/TESTSIDHANERLI/REPORTS/', //server test sidhanerli report folder path
