...
@Component({
  selector: 'app-cheque-collection-input-head',
  templateUrl: './cheque-collection-input-head.component.html',
  styleUrls: ['./cheque-collection-input-head.component.scss']
})
export class ChequeCollectionInputHeadComponent implements OnInit {
  //api 
