...
interface Pigmyagent {
  ...
  // S_NAME: string;
  // S_SHNAME:string;
  // S_INT_APPLICABLE:number;
  // MIN_INT_LIMIT:number;
  // STAND_INSTRUCTION_ALLOW:number;
  // WITHDRAWAL_APPLICABLE:number;
  // BALANCE_ADD_APPLICABLE:number;
...
export class PigmyAgentSchemeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  submit() {
    ...
    this.pigmyagentService.postData(dataToSend).subscribe(data1 => {
