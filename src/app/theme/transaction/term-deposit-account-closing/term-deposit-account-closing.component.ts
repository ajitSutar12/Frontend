...
export class TermDepositAccountClosingComponent implements OnInit {
  ...
  getAccountDetails(event) {
    // let acno = event.bankacno
    // let DEPO_AC_NO = event.label
    ...
    this.http.get(this.url + '/term-deposit-account-closing/details/' + mem).subscribe((data) => {
      ...
      //   Swal.fire('Oops', 'Do you want to transfer to loan account?', 'error')
      //   this.customer = null
      //   return
      // }
      ...
      //   Swal.fire({
      //     icon: 'warning',
      //     title: 'Do you want to transfer to loan account?',
