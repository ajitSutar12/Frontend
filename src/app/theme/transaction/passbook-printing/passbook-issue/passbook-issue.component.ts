...
export class PassbookIssueComponent implements OnInit {
  ...
  simpleOption: Array<IOption> = this.Scheme11Service.getCharacters();
  a : Array<IOption> = this.Scheme10Service.getCharacters();
  ...
  constructor(public Scheme10Service: Scheme10Service,public Scheme11Service: Scheme11Service,private fb: FormBuilder) { this.createForm(); }
