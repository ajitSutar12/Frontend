...
export class InvestmentAcRenewalComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private Multiservice: MultiVoucherService,private _service: TermDepositeAcRenewalService,
  ...
  createForm() {
    ...
    this.angForm = this.fb.group({
      branch_code: [''],
      date: [''],
      scheme_type: ['IV', [Validators.required]],
