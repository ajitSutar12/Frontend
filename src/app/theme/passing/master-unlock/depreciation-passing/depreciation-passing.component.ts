...
updateData() {
  if (this.itemArr.length != 0) {
    ...
    Swal.fire(`${this.translate.instant('Swal_Msg.Oops')}`, `${this.translate.instant('Swal_Msg.No_Data')}`, "error");
  }
}
...
reject() {
  if (this.itemArr.length != 0) {
    ...
    this.http.post(this.url + '/depreciation-process/reject', obj).subscribe(data => {
      ...
      this.ngOnInit()
      Swal.fire(
        `${this.translate.instant('Swal_Msg.Success')}`, `${this.translate.instant('Swal_Msg.stock')}`, 'success'
      );
    })
  }
  else {
...
Approve() {
  if (this.itemArr.length != 0) {
    ...
    this.http.post(this.url + '/depreciation-process/approv', obj).subscribe(data => {
      ...
      this.ngOnInit()
      Swal.fire(
        `${this.translate.instant('Swal_Msg.Success')}`, `${this.translate.instant('Swal_Msg.Deadstock1')}`, 'success'
      );
    })
  }
  else {
    Swal.fire(`${this.translate.instant('Swal_Msg.Oops')}`, `${this.translate.instant('Swal_Msg.To_Approve')}`, "error");
  }
}
unapprove() {
  if (this.itemArr.length != 0) {
    ...
    this.http.post(this.url + '/depreciation-process/unapprove', obj).subscribe(data => {
      ...
      this.ngOnInit()
      Swal.fire(
        `${this.translate.instant('Swal_Msg.Success')}`, `${this.translate.instant('Swal_Msg.Deadstock2')}`, 'success'
      );
    })
  }
  else {
