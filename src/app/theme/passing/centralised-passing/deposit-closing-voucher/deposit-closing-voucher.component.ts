  ...
  ngOnInit(): void {
    this.dtExportButtonOptions = {
      ...
      columns: [
        ...
        {
          title: this.translate.instant('Passing.Deposit_Closing_Date.Record_Number'),
          data: 'TRAN_NO'
        },
        {
          title: this.translate.instant('Passing.Deposit_Closing_Date.Closing_Status'),
          data: 'IS_PREMATURE_CLOSE'
        },
        {
          title: this.translate.instant('Passing.Deposit_Closing_Date.Token_Number'),
          data: 'TOKEN_NO'
        },
        {
          title: this.translate.instant('Passing.Deposit_Closing_Date.Net_Payable_Amount'),
          data: 'NET_PAYABLE_AMOUNT'
        },
        {
          title: this.translate.instant('Passing.Deposit_Closing_Date.Scheme_Type'),
          data: 'TRAN_ACTYPE'
        },
        // {
        //   title: 'Scheme Code',
        ...
        {
          title: this.translate.instant('Passing.Deposit_Closing_Date.Account_Number'),
          data: 'TRAN_ACNO'
        },
        // {
        //   title: 'Account Name',
        ...
        // },
        {
          title: this.translate.instant('Passing.Deposit_Closing_Date.User'),
          data: 'USER_CODE'
        },
        // {
        //   title: 'User Name',
