...
export class PasstermDepositAcRenewalComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.dtExportButtonOptions = {
      ...
      columns: [
        ...
        {
          title: this.translate.instant('Passing.Term_Deposit_Account_Renewal.Receipt_Number'),
          data: 'NEW_RECEIPTNO'
        },
