...
import { NpaclassificationStandardNonstandardRoutingModule } from './npaclassification-standard-nonstandard-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    NpaclassificationStandardNonstandardRoutingModule,
    SharedModule,
    FormsModule,
    ReactiveFormsModule,
    NgbModule,
...
export class NpaclassificationStandardNonstandardModule { }
