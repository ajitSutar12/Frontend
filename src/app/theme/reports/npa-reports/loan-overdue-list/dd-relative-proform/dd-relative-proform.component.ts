...
@Component({
  selector: 'app-dd-relative-proform',
  templateUrl: './dd-relative-proform.component.html',
  styleUrls: ['./dd-relative-proform.component.scss']
})
export class DdRelativeProformComponent implements OnInit {
