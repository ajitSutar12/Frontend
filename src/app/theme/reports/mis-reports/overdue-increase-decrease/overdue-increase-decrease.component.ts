...
@Component({
  selector: 'app-overdue-increase-decrease',
  templateUrl: './overdue-increase-decrease.component.html',
  styleUrls: ['./overdue-increase-decrease.component.scss']
})
export class OverdueIncreaseDecreaseComponent implements OnInit {
  ...
  view(event) {
    ...
    if (this.angForm.valid) {
      ...
      this.iframe5url = this.report_url + "examples/OverdueIncreaseDecrease.php?stadate='" + stadate + "'&edate='" + edate + "'&branched='" + this.ngbranch + "'&schemeid=" + myArray + "&flag=" + flag + "&branchName=" + this.branchName + "'&bankName='" + bankName + "'";
