...
View(event) {
  ...
  if (this.angForm.valid) {
    ...
    this.iframeurl = this.report_url + "examples/Expensisdetailreport.php?startDate='" + fromDate + "'&endDate='" + toDate + "'&Rdio='" + Rdio + "'&type='" + type + "'&scheme='" + branchName + "'&branch='" + branch + "&bankName=" + bankName + "";
