  ...
  view(event) {
    ...
    if (this.angForm.valid) {
      ...
      if (obj.RADIO == 'detail') {
        ...
        this.iframe1url = this.report_url+"examples/SLR.php?stadate='" + stadate + "'&edate='" + edate + "'&branched='" + branched +  "&flag=" + flag + "'&bankName='" + bankName + "'&branchName='"+this.branchName+  "'&startscheme='" + startscheme +"'";
        ...
        this.iframe1url = this.report_url+"examples/SLRSummary.php?stadate='" + stadate + "'&edate='" + edate + "'&branched='" + branched +  "&flag=" + flag +  "'&bankName='" + bankName + "'&branchName='"+this.branchName+ "'&startscheme='" + startscheme +"'";
      console.log(this.iframe1url);
      this.iframe1url = this.sanitizer.bypassSecurityTrustResourceUrl(this.iframe1url)
      }
