...
//for end date
  ...
  obj['END_DATE']=date 
      ...
      this.iframe5url = this.report_url + "examplese/Cidwisematureddeplist.php?&Branch='" + this.branchName + "'&BankName='" + bankName + "'&sdate='" + obj.START_DATE + "'&edate='" + obj.END_DATE + "'&trandrcr='D'&tran_status='1'&ac_op_cd='D'&AC_CUSTID='" + custid + "'&branch_code='"+branch+"'&S_ACNOTYPE='" + schemeName + "'&flag1='"+ flag +"'&sign='-'";
