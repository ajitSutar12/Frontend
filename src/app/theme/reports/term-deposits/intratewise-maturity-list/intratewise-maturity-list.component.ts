...
export class IntratewiseMaturityListComponent implements OnInit {
  ...
  view(event) {
    ...
    if (this.ngForm.valid) {
      ...
      this.iframe5url = this.report_url + "examples/AgentwisePigmyBalList.php?startdate='" + startdate + "'&enddate='" + enddate + + "'&schemecode=" + schemecode +
        "'&endint=" +endint +"'&startint=" + startint + "&branch=" + branch +"'&bankName=" + bankName +  "";
