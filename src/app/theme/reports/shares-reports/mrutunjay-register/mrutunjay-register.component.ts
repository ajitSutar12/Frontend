...
@Component({
  selector: 'app-mrutunjay-register',
  templateUrl: './mrutunjay-register.component.html',
  styleUrls: ['./mrutunjay-register.component.scss']
})
export class MrutunjayRegisterComponent implements OnInit {
  ...
  view(event){
    ...
    if(this.angForm.valid){
     ...
     this.iframe5url= this.report_url+"examples/yearly_interest_wise_classification_of_deposite.php?startDate='"+Date+"'&scheme='" + branch +  "'&branch='"+ this.ngbranch +"&bankName=" + bankName + ""+"'&enddate='"+Date1+"'&scheme'"+this.ngscheme;
