...
@Component({
  selector: 'app-bnk-gl-int-statement',
  templateUrl: './bnk-gl-int-statement.component.html',
  styleUrls: ['./bnk-gl-int-statement.component.scss']
})
export class BnkGlIntStatementComponent implements OnInit {
  maxDate: Date;
  minDate: Date;
  formSubmitted = false;
