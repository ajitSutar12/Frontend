...
@Component({
  selector: 'app-bnk-mem-statement',
  templateUrl: './bnk-mem-statement.component.html',
  styleUrls: ['./bnk-mem-statement.component.scss']
})
export class BnkMemStatementComponent implements OnInit {
  maxDate: Date;
  minDate: Date;
  formSubmitted = false;
