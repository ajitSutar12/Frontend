...
import { MemberTypewiseDepositClassificationRoutingModule } from './member-typewise-deposit-classification-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    MemberTypewiseDepositClassificationRoutingModule,
...
export class MemberTypewiseDepositClassificationModule { }
