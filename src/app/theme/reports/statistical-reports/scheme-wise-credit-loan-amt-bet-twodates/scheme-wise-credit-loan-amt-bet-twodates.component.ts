...
@Component({
  selector: 'app-scheme-wise-credit-loan-amt-bet-twodates',
  templateUrl: './scheme-wise-credit-loan-amt-bet-twodates.component.html',
  styleUrls: ['./scheme-wise-credit-loan-amt-bet-twodates.component.scss']
})
export class SchemeWiseCreditLoanAmtBetTwodatesComponent implements OnInit {
 ...
 AddSchemeData() {
   this.http.get('http://192.168.1.141:3000/ledger-view/schems').subscribe((data: any[]) => {
 ...
 view(event) {
   ...
   if (this.angForm.controls['RADIO'].value == "detail" && this.angForm.valid) {
     ...
     this.iframe1url = this.report_url + "examples/SchemeWiseCrLoanBet2Dates.php?stadate='" + stadate + "'&edate='" + edate + "'&branched='" + branched + "'&detail='" + detail + "'&startscheme='" + startscheme + "'&bankName='" + bankName + "'&branchName='" + branchName + "'";
     ...
     this.iframe1url = this.report_url + "examples/SchemeWiseCrLoanBet2Dates.php?stadate='" + stadate + "'&edate='" + edate + "'&branched='" + branched + "'&detail='" + summary + "'&startscheme='" + startscheme + "'&bankName='" + bankName + "'&branchName='" + this.branchName + "'";
     console.log(this.iframe1url);
     this.iframe1url = this.sanitizer.bypassSecurityTrustResourceUrl(this.iframe1url);
   }
   else {
