...
import {BnkNonGuaranteerViewRoutingModule} from './bnk-non-guaranteer-view-routing.module';
...
@NgModule({
  ...
  exports:[BnkNonGuaranteerViewComponent],
  providers: [
    {
...
export class BnkNonGuaranteerViewModule { }