...
export class GoldSilverSecurityComponent implements OnInit {
  iframe5url: any = '';
  ...
  view(event) {
    ...
    if (this.ngForm.valid) {
      ...
      this.iframe5url = this.report_url + "examples/GoldSilverSecurity.php?START_DATE='" + obj.START_DATE+ "'&END_DATE='" + obj.END_DATE+ "'&BRANCH='"+this.branchName+"'&AC_TYPE='" +scheme+ "'&AC_ACNOTYPE='" + schemeName+ "'";
