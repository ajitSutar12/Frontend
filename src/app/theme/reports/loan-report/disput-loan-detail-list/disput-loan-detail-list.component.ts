...
@Component({
  selector: 'app-disput-loan-detail-list',
  templateUrl: './disput-loan-detail-list.component.html',
  styleUrls: ['./disput-loan-detail-list.component.scss']
})
export class DisputLoanDetailListComponent implements OnInit {
  ...
  View(event) {
    ...
    if (this.angForm.valid) {
      ...
      this.iframe5url = this.report_url + "examples/DisputeLoanDetailsList.php?&fromdate='" + stadate + "'&todate='" + edate + "&AC_ACNOTYPE='" + this.getschemename + "&branchName='" + branchName + "'&bankName='" + bankName + "'";
