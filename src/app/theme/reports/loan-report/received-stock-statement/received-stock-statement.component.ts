...
export class ReceivedStockStatementComponent implements OnInit {
  iframe5url: any = '';
  ...
  view(event) {
    ...
    if (this.ngForm.valid) {
      ...
      this.iframe5url = this.report_url + "examples/ReceivedStockStatement.php?&Branch='" + this.branchName+ "'&sdate='" + obj.START_DATE + "'&BankName='" + bankName + "'&edate='" + obj.END_DATE + "'&branch_code='"+ branch +"'&AC_ACNOTYPE='" + schemeName + "'";
