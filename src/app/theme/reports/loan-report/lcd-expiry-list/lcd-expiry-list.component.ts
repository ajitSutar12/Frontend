...
export class LcdExpiryListComponent implements OnInit {
  ...
  view(event) {
    ...
    if (this.ngForm.valid) {
      ...
      this.iframeurl5 = this.report_url + "examples/loancashcredit.php?LIST_DATE='" + startdate + "'&SDATE='" + enddate + "'&ACTYPE='" + scheme + "'&branch='" + branch + "&bankName=" + bankName + "&TRANDRCR='D'&TRANSTATUS='1'&NAME=''&ACACNOTYPE='LN'";
