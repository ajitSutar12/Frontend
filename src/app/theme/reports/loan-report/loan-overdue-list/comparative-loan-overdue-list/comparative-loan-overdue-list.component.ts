...
@Component({
  selector: 'app-comparative-loan-overdue-list',
  templateUrl: './comparative-loan-overdue-list.component.html',
  styleUrls: ['./comparative-loan-overdue-list.component.scss']
})
export class ComparativeLoanOverdueListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //  get scheme values of dropdown endpoint
  ...
  view(event) {
    ...
    if (this.angForm.valid) {
      ...
      this.iframe5url = this.report_url + "examples/comparativeLoanOverdueList.php?startDate='" + startDate + "'&branched='" + this.ngbranch + "'&actype='" + this.acType + "'&bankName=" + bankName + "&branchName=" + this.branchName + "&Scheme_code='" + Scheme_code + "'";
