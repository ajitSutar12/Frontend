...
maxDate: Date;
 ...
 this.iframe5url=this.report_url+ "examples/receivable_installmentandinterest.php?date='"+ obj.date +"'&branchName='"+ branchName +"'&FLAG=1&AC_TYPE='12'&branch='"+ branch +"'&bankName='"+bankName +"'";
