...
maxDate: Date;
 ...
 this.iframe5url=this.report_url+ "examples/receivable_installmentandinterest.php?date='"+ obj.date +"'&branchName='"+ branchName +"'&FLAG=1&scheme_name='"+schemeName+"'&branch='"+ branch +"'&bankName='"+bankName +"'&scheme='"+scheme +"'";
