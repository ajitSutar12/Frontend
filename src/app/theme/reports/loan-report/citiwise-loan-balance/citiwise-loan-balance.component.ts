...
this.iframe5url=this.report_url+ "examples/citywise_loan_balance_report.php?branchName='KOTOLI'&stdate='"+ obj.START_DATE +"'&etdate='"+ obj.START_DATE +"'&AC_TYPE='"+scheme +"'&AC_ACNOTYPE='"+schemeName +"'&AC_CTCODE='"+ ctcode +"'&bankName='"+bankName+"'&branch_code='"+branch+"'"
