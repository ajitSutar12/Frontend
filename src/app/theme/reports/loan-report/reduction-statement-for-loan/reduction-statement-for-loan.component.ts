...
@Component({
  selector: 'app-reduction-statement-for-loan',
  templateUrl: './reduction-statement-for-loan.component.html',
  styleUrls: ['./reduction-statement-for-loan.component.scss'],
  providers: [SchemeCodeDropdownService, SchemeAccountNoService, OwnbranchMasterService]

})
export class ReductionStatementForLoanComponent implements OnInit {
   ...
   createForm() {
     this.ngForm = this.fb.group({
       ...
       RADIO: new FormControl('provisional'),
   ...
   View(event) {
     ...
     this.iframe5url=this.report_url+"examples/DeductionStatement.php?startDate='" + startDate +"'&endDate='"+endDate+ "'&branch='"+this.ngbranch+"'&sdate='"+sdate+"&scheme= "+scheme+"' &bankName=" + bankName +"'&branchName="+branchName+"&flag="+flag+ "";
