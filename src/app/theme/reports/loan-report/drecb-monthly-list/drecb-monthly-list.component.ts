...
@Component({
  selector: 'app-drecb-monthly-list',
  templateUrl: './drecb-monthly-list.component.html',
  styleUrls: ['./drecb-monthly-list.component.scss']
})
export class DRecbMonthlyListComponent implements OnInit {
