...
const routes = [
    {
        ...
        children: [
            {
                path: 'dividendList',
                loadChildren: () => __webpack_require__.e(/*! import() | dividend-list-dividend-list-module */ "dividend-list-dividend-list-module").then(__webpack_require__.bind(null, /*! ./dividend-list/dividend-list.module */ "./src/app/theme/utility/dividend/dividend-list/dividend-list.module.ts")).then(m => m.DividendListModule)
            },
            {
                path: 'dividendPost',
                loadChildren: () => __webpack_require__.e(/*! import() | dividend-post-dividend-post-module */ "dividend-post-dividend-post-module").then(__webpack_require__.bind(null, /*! ./dividend-post/dividend-post.module */ "./src/app/theme/utility/dividend/dividend-post/dividend-post.module.ts")).then(m => m.DividendPostModule)
            },
        ]
    }
];
