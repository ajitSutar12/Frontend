...
BnkGurDetailsListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BnkGurDetailsListComponent, selectors: [["app-bnk-gur-details-list"]], decls: 68, vars: 19, consts: [[1, "row"], [1, "col-12"], [1, "card"], [1, "card-header"], [1, "requiredlable", 2, "float", "right", "font-size", "12px", "color", "black"], [1, "required"], ["novalidate", "", 3, "formGroup"], [1, "card-block"], [1, "col-sm-12", "col-md-2"], ["for", "scheme"], [1, "form-group", "form-primary", "form-static-label"], [1, "border-lable-flt"], ["bindValue", "value", "bindLabel", "label", "formControlName", "BRANCH_CODE", "placeholder", "Branch", "required", "", 3, "ngModel", "ngClass", "ngModelChange"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "form-group form-primary form-static-label", "class", "alert alert-danger", 4, "ngIf"], ["for", "AC_CUSTID"], ["bindLabel", "label", "bindValue", "value", "formControlName", "AC_CUSTID", "placeholder", "Customer Id", "required", "", 3, "ngModel", "ngClass", "ngModelChange"], ["for", "FROM_DATE"], [1, "form-group", "input-group"], ["type", "text", "placeholder", "dd/mm/yyyy", "name", "Date", "id", "Date", "appButton", "", "minlength", "10", "maxlength", "10", "formControlName", "date", "bsDatepicker", "", 1, "form-control", 3, "bsConfig", "ngModel", "ngModelChange", "keypress"], [1, "checkbox", "checkbox-primary"], [1, "border-checkbox-group", "border-checkbox-group-primary"], ["type", "checkbox", "id", "PRINT_CUSTID", "formControlName", "PRINT_CUSTID", 1, "border-checkbox"], ["for", "PRINT_CUSTID", 1, "border-checkbox-label"], [1, "col-md-9"], [1, "col-md-2"], ["value", "submit", 1, "btn", "btn-outline-primary", "btn-sm", 3, "disabled", "click"], [1, "col-md-1"], [1, "btn", "btn-outline-primary", "btn-sm", 3, "click"], [4, "ngIf"], [3, "value"], [1, "alert", "alert-danger"], [3, "url"]], template: function BnkGurDetailsListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BnkGurDetailsListComponent_Template_button_click_56_listener($event) { ctx.view($event); return ctx.clicked = true; });
