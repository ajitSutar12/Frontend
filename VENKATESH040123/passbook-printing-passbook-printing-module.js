...
const routes = [
    {
        ...
        children: [
            {
                path: 'passbookIssue',
                loadChildren: () => Promise.all(/*! import() | passbook-issue-passbook-issue-module */[__webpack_require__.e("default~abtypedeposit-list-abtypedeposit-list-module~accept-d-accept-d-module~account-enquiry-accoun~da894787"), __webpack_require__.e("default~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-enquiry-module~account-~e8b6ac50"), __webpack_require__.e("default~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-enquiry-module~account-~f2008b51"), __webpack_require__.e("default~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-enquiry-module~all-repo~4072ad24"), __webpack_require__.e("passbook-issue-passbook-issue-module")]).then(__webpack_require__.bind(null, /*! ./passbook-issue/passbook-issue.module */ "./src/app/theme/transaction/passbook-printing/passbook-issue/passbook-issue.module.ts")).then(m => m.PassbookIssueModule)
            },
            {
                path: 'passbookEntryPrint',
                loadChildren: () => Promise.all(/*! import() | passbook-entry-print-passbook-entry-print-module */[__webpack_require__.e("default~abtypedeposit-list-abtypedeposit-list-module~accept-d-accept-d-module~account-enquiry-accoun~da894787"), __webpack_require__.e("default~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-enquiry-module~account-~e8b6ac50"), __webpack_require__.e("default~abtypedeposit-list-abtypedeposit-list-module~account-enquiry-account-enquiry-module~account-~f2008b51"), __webpack_require__.e("passbook-entry-print-passbook-entry-print-module")]).then(__webpack_require__.bind(null, /*! ./passbook-entry-print/passbook-entry-print.module */ "./src/app/theme/transaction/passbook-printing/passbook-entry-print/passbook-entry-print.module.ts")).then(m => m.PassbookEntryPrintModule)
            },
        ]
    }
];
