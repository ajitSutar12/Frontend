        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | centralised-passing-centralisedPassing-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~96429515"), __webpack_require__.e("centralised-passing-centralisedPassing-module")]).then(__webpack_require__.bind(null, /*! ./centralised-passing/centralisedPassing.module */ "./src/app/theme/passing/centralised-passing/centralisedPassing.module.ts")).then(m => m.CentralisedPassingModule)
            },
            //
            {
                path: 'sharesTransactionPassing',
                loadChildren: () => Promise.all(/*! import() | shares-transaction-passing-sharesTransactionPassing-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~96429515"), __webpack_require__.e("shares-transaction-passing-sharesTransactionPassing-module")]).then(__webpack_require__.bind(null, /*! ./shares-transaction-passing/sharesTransactionPassing.module */ "./src/app/theme/passing/shares-transaction-passing/sharesTransactionPassing.module.ts")).then(m => m.SharesTransactionPassingModule)
            },
            //
            {
                path: 'unapproval',
                loadChildren: () => Promise.all(/*! import() | unapproval-unapproval-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~96429515"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~4e4f68e3"), __webpack_require__.e("default~day-book-ie-day-book-ie-module~dead-stock-transaction-dead-stock-transaction-module~demand-d~0b944824"), __webpack_require__.e("unapproval-unapproval-module")]).then(__webpack_require__.bind(null, /*! ./unapproval/unapproval.module */ "./src/app/theme/passing/unapproval/unapproval.module.ts")).then(m => m.UnapprovalModule)
            },
            //
            {
                path: 'masterUnlock',
                loadChildren: () => Promise.all(/*! import() | master-unlock-masterUnlock-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~96429515"), __webpack_require__.e("master-unlock-masterUnlock-module")]).then(__webpack_require__.bind(null, /*! ./master-unlock/masterUnlock.module */ "./src/app/theme/passing/master-unlock/masterUnlock.module.ts")).then(m => m.MasterUnlockModule)
            },
        ]
    }
];
