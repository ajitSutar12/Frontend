        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | dividend-calculation-dividend-calculation-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~96429515"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~24a2a2a5"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~4e4f68e3"), __webpack_require__.e("dividend-calculation-dividend-calculation-module")]).then(__webpack_require__.bind(null, /*! ./dividend-calculation/dividend-calculation.module */ "./src/app/theme/master/shares/dividend-calculation/dividend-calculation.module.ts")).then(m => m.DividendCalculationModule)
            },
            {
