...
const routes = [
    {
        ...
        children: [
            {
                path: 'information',
                loadChildren: () => Promise.all(/*! import() | information-information-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~24a2a2a5"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~4e4f68e3"), __webpack_require__.e("default~anamat-gsm-anamat-gsm-module~batch-voucher-batch-voucher-module~cash-credit-ac-renewal-cash-~6f4a72fa"), __webpack_require__.e("default~anamat-gsm-anamat-gsm-module~customer-id-customer-id-module~dead-stock-master-dead-stock-mas~9c8fd8c2"), __webpack_require__.e("common"), __webpack_require__.e("information-information-module")]).then(__webpack_require__.bind(null, /*! ./information/information.module */ "./src/app/theme/master/policy-settings/information/information.module.ts")).then(m => m.InformationModule)
            },
            {
                path: 'definations',
                loadChildren: () => Promise.all(/*! import() | definations-definations-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~24a2a2a5"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~4e4f68e3"), __webpack_require__.e("default~anamat-gsm-anamat-gsm-module~batch-voucher-batch-voucher-module~cash-credit-ac-renewal-cash-~6f4a72fa"), __webpack_require__.e("default~anamat-gsm-anamat-gsm-module~customer-id-customer-id-module~dead-stock-master-dead-stock-mas~9c8fd8c2"), __webpack_require__.e("default~definations-definations-module~demo-demo-module~form-picker-form-picker-module~pigmy-chart-e~5951f87c"), __webpack_require__.e("common"), __webpack_require__.e("definations-definations-module")]).then(__webpack_require__.bind(null, /*! ./definations/definations.module */ "./src/app/theme/master/policy-settings/definations/definations.module.ts")).then(m => m.DefinationsModule)
            },
            {
                path: 'sizewiseBalanceModification',
                loadChildren: () => Promise.all(/*! import() | sizewise-balance-modification-sizewise-balance-modification-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~24a2a2a5"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~4e4f68e3"), __webpack_require__.e("default~definations-definations-module~demo-demo-module~form-picker-form-picker-module~pigmy-chart-e~5951f87c"), __webpack_require__.e("sizewise-balance-modification-sizewise-balance-modification-module")]).then(__webpack_require__.bind(null, /*! ./sizewise-balance-modification/sizewise-balance-modification.module */ "./src/app/theme/master/policy-settings/sizewise-balance-modification/sizewise-balance-modification.module.ts")).then(m => m.SizewiseBalanceModificationModule)
            },
            {
                path: 'tDReceiptTypeMaster',
                loadChildren: () => Promise.all(/*! import() | t-dreceipt-type-master-t-dreceipt-type-master-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~24a2a2a5"), __webpack_require__.e("t-dreceipt-type-master-t-dreceipt-type-master-module")]).then(__webpack_require__.bind(null, /*! ./t-dreceipt-type-master/t-dreceipt-type-master.module */ "./src/app/theme/master/policy-settings/t-dreceipt-type-master/t-dreceipt-type-master.module.ts")).then(m => m.TDReceiptTypeMasterModule)
            },
            {
                path: 'nPAClassificationSlabMaster',
                loadChildren: () => Promise.all(/*! import() | n-paclassification-slab-master-n-paclassification-slab-master-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~24a2a2a5"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~4e4f68e3"), __webpack_require__.e("n-paclassification-slab-master-n-paclassification-slab-master-module")]).then(__webpack_require__.bind(null, /*! ./n-paclassification-slab-master/n-paclassification-slab-master.module */ "./src/app/theme/master/policy-settings/n-paclassification-slab-master/n-paclassification-slab-master.module.ts")).then(m => m.NPAClassificationSlabMasterModule)
            },
        ]
    }
];
...
PolicySettingsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function PolicySettingsModule_Factory(t) { return new (t || PolicySettingsModule)(); }, imports: [[
