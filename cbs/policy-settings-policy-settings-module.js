...
const routes = [
    {
        ...
        children: [
            {
                path: 'information',
                loadChildren: () => Promise.all(/*! import() | information-information-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3f7b7e67"), __webpack_require__.e("default~account-opening-account-opening-module~anamat-gsm-anamat-gsm-module~batch-voucher-batch-vouc~c85ad180"), __webpack_require__.e("default~account-opening-account-opening-module~anamat-gsm-anamat-gsm-module~cash-credit-master-cash-~34151e30"), __webpack_require__.e("common"), __webpack_require__.e("information-information-module")]).then(__webpack_require__.bind(null, /*! ./information/information.module */ "./src/app/theme/master/policy-settings/information/information.module.ts")).then(m => m.InformationModule)
            },
            {
                path: 'definations',
                loadChildren: () => Promise.all(/*! import() | definations-definations-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3f7b7e67"), __webpack_require__.e("default~account-opening-account-opening-module~anamat-gsm-anamat-gsm-module~batch-voucher-batch-vouc~c85ad180"), __webpack_require__.e("default~account-opening-account-opening-module~anamat-gsm-anamat-gsm-module~cash-credit-master-cash-~34151e30"), __webpack_require__.e("default~definations-definations-module~demo-demo-module~form-picker-form-picker-module~pigmy-chart-e~5951f87c"), __webpack_require__.e("common"), __webpack_require__.e("definations-definations-module")]).then(__webpack_require__.bind(null, /*! ./definations/definations.module */ "./src/app/theme/master/policy-settings/definations/definations.module.ts")).then(m => m.DefinationsModule)
            },
            {
                path: 'sizewiseBalanceModification',
                loadChildren: () => Promise.all(/*! import() | sizewise-balance-modification-sizewise-balance-modification-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3f7b7e67"), __webpack_require__.e("default~definations-definations-module~demo-demo-module~form-picker-form-picker-module~pigmy-chart-e~5951f87c"), __webpack_require__.e("sizewise-balance-modification-sizewise-balance-modification-module")]).then(__webpack_require__.bind(null, /*! ./sizewise-balance-modification/sizewise-balance-modification.module */ "./src/app/theme/master/policy-settings/sizewise-balance-modification/sizewise-balance-modification.module.ts")).then(m => m.SizewiseBalanceModificationModule)
            },
            {
            ...
            },
            {
                ...
                loadChildren: () => Promise.all(/*! import() | n-paclassification-slab-master-n-paclassification-slab-master-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3f7b7e67"), __webpack_require__.e("n-paclassification-slab-master-n-paclassification-slab-master-module")]).then(__webpack_require__.bind(null, /*! ./n-paclassification-slab-master/n-paclassification-slab-master.module */ "./src/app/theme/master/policy-settings/n-paclassification-slab-master/n-paclassification-slab-master.module.ts")).then(m => m.NPAClassificationSlabMasterModule)
            },
        ]
    }
];
