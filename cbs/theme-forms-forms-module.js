...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'select',
                loadChildren: () => Promise.all(/*! import() | form-select-form-select-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~3f7b7e67"), __webpack_require__.e("default~account-opening-account-opening-module~anamat-gsm-anamat-gsm-module~batch-voucher-batch-vouc~c85ad180"), __webpack_require__.e("default~day-book-ie-day-book-ie-module~dead-stock-transaction-dead-stock-transaction-module~demand-d~0b944824"), __webpack_require__.e("default~advance-elements-advance-elements-module~crm-dashboard-crm-dashboard-module~data-widget-data~3d7ac973"), __webpack_require__.e("default~advance-elements-advance-elements-module~form-select-form-select-module"), __webpack_require__.e("common"), __webpack_require__.e("form-select-form-select-module")]).then(__webpack_require__.bind(null, /*! ./form-select/form-select.module */ "./src/app/theme/forms/form-select/form-select.module.ts")).then(m => m.FormSelectModule)
            },
            {
                path: 'form-wizards',
