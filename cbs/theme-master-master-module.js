...
const routes = [{
        ...
        children: [
            ...
            {
                path: 'Instruction',
                loadChildren: () => Promise.all(/*! import() | instruction-instruction-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~96429515"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~24a2a2a5"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~4e4f68e3"), __webpack_require__.e("default~day-book-ie-day-book-ie-module~dead-stock-transaction-dead-stock-transaction-module~demand-d~0b944824"), __webpack_require__.e("common"), __webpack_require__.e("instruction-instruction-module")]).then(__webpack_require__.bind(null, /*! ./instruction/instruction.module */ "./src/app/theme/master/instruction/instruction.module.ts")).then(m => m.InstructionModule)
            },
            {
                path: 'Investment',
