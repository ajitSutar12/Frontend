...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'auth',
                loadChildren: () => Promise.all(/*! import() | theme-auth-auth-module */[__webpack_require__.e("default~account-opening-account-opening-module~anamat-gsm-anamat-gsm-module~batch-voucher-batch-vouc~4d4caf63"), __webpack_require__.e("default~account-opening-account-opening-module~anamat-gsm-anamat-gsm-module~cash-credit-master-cash-~afc58727"), __webpack_require__.e("theme-auth-auth-module")]).then(__webpack_require__.bind(null, /*! ./theme/auth/auth.module */ "./src/app/theme/auth/auth.module.ts")).then(m => m.AuthModule)
            },
            {
