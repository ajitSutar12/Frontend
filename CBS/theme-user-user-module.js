...
const routes = [
    {
        ...
        children: [
            {
                path: 'profile',
                loadChildren: () => Promise.all(/*! import() | user-profile-user-profile-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~43e8970d"), __webpack_require__.e("default~email-compose-email-compose-module~ext-tinymce-ext-tinymce-module~user-profile-user-profile-module"), __webpack_require__.e("user-profile-user-profile-module")]).then(__webpack_require__.bind(null, /*! ./user-profile/user-profile.module */ "./src/app/theme/user/user-profile/user-profile.module.ts")).then(m => m.UserProfileModule)
            },
            {
                path: 'card',
