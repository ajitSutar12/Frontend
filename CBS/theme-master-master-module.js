...
const routes = [{
        ...
        children: [
            {
                path: 'generalLedger',
                loadChildren: () => Promise.all(/*! import() | general-ledger-generalLedger-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~e7fd387c"), __webpack_require__.e("default~day-book-ie-day-book-ie-module~dead-stock-transaction-dead-stock-transaction-module~demand-d~0b944824"), __webpack_require__.e("general-ledger-generalLedger-module")]).then(__webpack_require__.bind(null, /*! ./general-ledger/generalLedger.module */ "./src/app/theme/master/general-ledger/generalLedger.module.ts")).then(m => m.GeneralLedgerModule)
            },
            {
                path: 'customer',
            ...
            {
                path: 'PolicySettings',
                loadChildren: () => Promise.all(/*! import() | policy-settings-policy-settings-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~43e8970d"), __webpack_require__.e("policy-settings-policy-settings-module")]).then(__webpack_require__.bind(null, /*! ./policy-settings/policy-settings.module */ "./src/app/theme/master/policy-settings/policy-settings.module.ts")).then(m => m.PolicySettingsModule)
            },
            {
                path: 'Maintainance',
                loadChildren: () => Promise.all(/*! import() | maintainance-maintainance-module */[__webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~e7fd387c"), __webpack_require__.e("default~day-book-ie-day-book-ie-module~dead-stock-transaction-dead-stock-transaction-module~demand-d~0b944824"), __webpack_require__.e("maintainance-maintainance-module")]).then(__webpack_require__.bind(null, /*! ./maintainance/maintainance.module */ "./src/app/theme/master/maintainance/maintainance.module.ts")).then(m => m.MaintainanceModule)
            },
            {
                path: 'Instruction',
                loadChildren: () => Promise.all(/*! import() | instruction-instruction-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~43e8970d"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~1587de72"), __webpack_require__.e("default~account-close-passing-account-close-passing-module~account-closing-account-closing-module~ac~e7fd387c"), __webpack_require__.e("default~day-book-ie-day-book-ie-module~dead-stock-transaction-dead-stock-transaction-module~demand-d~0b944824"), __webpack_require__.e("common"), __webpack_require__.e("instruction-instruction-module")]).then(__webpack_require__.bind(null, /*! ./instruction/instruction.module */ "./src/app/theme/master/instruction/instruction.module.ts")).then(m => m.InstructionModule)
            },
            {
                path: 'Investment',
            ...
            },
            {
                ...
                loadChildren: () => Promise.all(/*! import() | signature-scanning-signature-scanning-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~43e8970d"), __webpack_require__.e("common"), __webpack_require__.e("signature-scanning-signature-scanning-module")]).then(__webpack_require__.bind(null, /*! ./signature-scanning/signature-scanning.module */ "./src/app/theme/master/signature-scanning/signature-scanning.module.ts")).then(m => m.SignatureScanningModule)
            },
            {
                path: 'DDBankCityMaster',
                loadChildren: () => Promise.all(/*! import() | dd-bank-city-master-dd-bank-city-master-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~43e8970d"), __webpack_require__.e("dd-bank-city-master-dd-bank-city-master-module")]).then(__webpack_require__.bind(null, /*! ./dd-bank-city-master/dd-bank-city-master.module */ "./src/app/theme/master/dd-bank-city-master/dd-bank-city-master.module.ts")).then(m => m.DDBankCityMasterModule)
            },
        ]
    }];
