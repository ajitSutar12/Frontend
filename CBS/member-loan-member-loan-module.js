        ...
        children: [
            {
                ...
                loadChildren: () => Promise.all(/*! import() | loan-application-loan-application-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~43e8970d"), __webpack_require__.e("loan-application-loan-application-module")]).then(__webpack_require__.bind(null, /*! ./loan-application/loan-application.module */ "./src/app/theme/transaction/member-loan/loan-application/loan-application.module.ts")).then(m => m.LoanApplicationModule)
            },
            {
                path: 'loanSanction',
                loadChildren: () => Promise.all(/*! import() | loan-sanction-loan-sanction-module */[__webpack_require__.e("default~accept-d-accept-d-module~account-close-passing-account-close-passing-module~account-closing-~43e8970d"), __webpack_require__.e("loan-sanction-loan-sanction-module")]).then(__webpack_require__.bind(null, /*! ./loan-sanction/loan-sanction.module */ "./src/app/theme/transaction/member-loan/loan-sanction/loan-sanction.module.ts")).then(m => m.LoanSanctionnModule)
            },
        ]
    }
];
...
MemberLoanModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function MemberLoanModule_Factory(t) { return new (t || MemberLoanModule)(); }, imports: [[
